...
class IdentificationKey {
  ...
  KeyOption parseOption(xml.XmlElement e)
  {
    ...
    String text = e.findElements("text").toString();
    String description = e.findElements("description").toString();
    String imageLocation = e.findElements("imageLocation").toString();
  ...
  ResultNode parseResult (xml.XmlElement e) {
    ...
    String id = e.getAttribute("id");
    String ordem = e.findElements("ordem").toString();
    String description = e.findElements("description").toString();
    String imageLocation = e.findElements("imageLocation").toString();
